...
def Mating_Main():
    ...
    for parent_num in range(num_parents):
        ...
        parents_vel_df.append(pd.read_csv(path + f'\WSC Energy Management Model({max_fitness_idx}).csv', usecols = ['Segment Velocity (km/h)']))
    ...
    parents.to_csv(path + '\Breeding_Parents.csv', index = False, header = False)
